            ...
            <section class="task-panel tasks-widget">
              ...
              <div class="panel-body">
                     ...
                     for ($i=0; $i <count($requet); $i++){ 
                      ...
                      <div class="task-title">
                        ...
                        <div class="pull-right hidden-phone">
                          <button class="btn btn-success btn-xs"><a <?php echo "href='".$reunion['url']."'"; ?> ><i class=" fa fa-check">Joindre</i></a></button>
                        </div>
                      </div>
                    <?php }?>
                ...
                <div class=" add-task-row">
                  <a class="btn btn-success btn-sm pull-left" href="/newReunions/Medicin475">Ajouter une nouvelle réunion</a>
                </div>
              </div>
            </section>
          </div>
