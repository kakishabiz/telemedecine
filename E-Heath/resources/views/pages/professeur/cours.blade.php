        ...
        <div class="col-lg-7">
          <div class="courses_search_container">
            <form action="#" id="courses_search_form" class="courses_search_form d-flex flex-row align-items-center justify-content-start">
              <input type="search" class="courses_search_input" placeholder="Rechercher" required="required" name="cour">
              <select id="courses_search_select" class="courses_search_select courses_search_input" name="categorie">
                <option>Toutes les catégories</option>
                <option>Chirurgie</option>
                <option>Pédiatrie</option>
                <option>Dermatologie</option>
              </select>
              <button action="submit" class="courses_search_button ml-auto" name="rechercher">Rechercher</button>
            </form>
          </div>
          ...
          <div class="courses_container">
            <?php
              ...
              <?php 
                    ...
                    ->where('id','=',$idCour['idUser'])
                    ->where('nomDucours','=',$_REQUEST['cour'])->get();
              ...
              <div class="col-lg-6 course_col">
                <div class="course">
                  ...
                  <div class="course_body">
                    <h3 class="course_title"><a href="courProf"><?php echo($cour['nomDucours']) ?></a></h3>
              ...
              <div class="sidebar_latest">
                ...
                <div class="latest d-flex flex-row align-items-start justify-content-start">
                  ...
                  <div class="latest_content">
                    <div class="latest_title"><a href="cour">Les maladies héréditaires</a></div>
                  </div>
                </div>
                <!-- Latest Course -->
                <div class="latest d-flex flex-row align-items-start justify-content-start">
                  ...
                  <div class="latest_content">
                    <div class="latest_title"><a href="cour">COVID-19</a></div>
                  </div>
                </div>
              </div>
            </div>
